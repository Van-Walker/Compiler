...
public class IRProgram implements BuiltinElements {
    ...
    public IRProgram() {
        ...
        initFunc.exit = new IRBlock(initFunc, "return");
    ...
    public String toString() {
        ...
        for (StringConst str : stringConst.values())
            ret.append("@str.").append(String.valueOf(str.id)).append(" = private unnamed_addr constant [").append(String.valueOf(str.val.length() + 1)).append(" x i8] c\"").append(str.print()).append("\"\n");
        ...
        ret.append("declare i32 @string_length(ptr)\n");
        ...
        ret.append("declare ptr @string_substring(ptr, i32, i32)\n");
        ret.append("declare i32 @string_parseInt(ptr)\n");
        ret.append("declare i32 @string_ord(ptr, i32)\n");
        ret.append("declare ptr @string_add(ptr, ptr)\n");
        ret.append("declare i1 @string_equal(ptr, ptr)\n");
        ret.append("declare i1 @string_notEqual(ptr, ptr)\n");
        ret.append("declare i1 @string_less(ptr, ptr)\n");
        ret.append("declare i1 @string_lessOrEqual(ptr, ptr)\n");
        ret.append("declare i1 @string_greater(ptr, ptr)\n");
        ret.append("declare i1 @string_greaterOrEqual(ptr, ptr)\n\n");
